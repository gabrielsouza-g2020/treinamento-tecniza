...
function validaCPF(){
    ...
    if (cpf.length !== 11){
        mostraResultado('CPF inválido! Deve conter 11 digitos','red');
        return;
    }
    ...
    if (!digito1){
        mostraResultado(`CPF inválido  IRREGULAR - ${cpfFormatado}`, 'red');
        return;
    }
    ...
    if (!digito2){
        ...
        mostraResultado('CPF válido! REGULAR','green');
    }
